...
public:
    ...
    /**
     * @brief Détermine la hauteur du terrain au point \e p. \n
     * Redéfinition de la méthode. (cf. Object). \n
     * Utilise la méthode getHauteur(float x, float y).
     * @param[in] p un point dans l'espace x, y, z.
     * @return La hauteur du terrain en \e p.
     */
...
protected:
     ...
     * @param[in] x la position en x du point.
     * @param[in] y la position en y du point.
     * @return La normal à la position \e x,\e y
     */
     ...
     * @param[in] hauteur La hauteur par rapport au terrain.
     */
